...
--> statement-breakpoint
ALTER TABLE "files" ADD COLUMN "workflow_run_id" text;--> statement-breakpoint
ALTER TABLE "files" ADD COLUMN "error_message" text;--> statement-breakpoint
ALTER TABLE "files" ADD COLUMN "last_error_at" timestamp;--> statement-breakpoint
ALTER TABLE "files" ADD COLUMN "failed_records" integer DEFAULT 0;--> statement-breakpoint
