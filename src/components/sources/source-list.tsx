  ...
  return (
    <div className="overflow-hidden rounded-lg border border-zinc-800">
      ...
      <div className="flex items-center gap-4 border-b border-zinc-800 px-4 py-2 text-xs font-medium uppercase tracking-wider text-zinc-500">
        <div className="w-[26%] min-w-0">Name</div>
        <div className="w-[10%]">Status</div>
        <div className="w-[14%] text-right">Records</div>
        <div className="w-[11%] text-right">Size</div>
        <div className="w-[17%] text-right">Date Range</div>
        <div className="w-[14%] text-right">Analytics</div>
      </div>
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-zinc-800">
      ...
      {SKELETON_IDS.map((id) => (
        <div
          key={id}
          className="flex items-center gap-4 border-b border-zinc-800 px-4 py-3.5 last:border-b-0"
        >
          <div className="w-[26%] min-w-0 flex flex-col gap-1">
          ...
          <div className="w-[17%] flex items-center justify-end">
            <Skeleton className="h-4 w-16" />
          </div>
          <div className="w-[14%] flex items-center justify-end">
            <Skeleton className="h-4 w-14" />
